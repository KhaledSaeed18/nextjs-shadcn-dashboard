...
import { Home, Settings, Users, FileText, ChevronDown, LayoutDashboard, LockKeyhole, FileCog, ChevronUp, User2 } from "lucide-react"
        ...
        <SidebarGroup>
          <SidebarGroupContent>
            <SidebarMenu>
              ...
              <SidebarMenuItem>
                <MenuItemWrapper label="Users">
                  <SidebarMenuButton asChild>
                    <Link
                      aria-label="Go to Users"
                      href="/dashboard/users"
                      className={`flex items-center ${pathname === "/dashboard/users" ? "text-primary bg-gray-200 dark:bg-black/50" : ""}`}
                    >
              ...
              <SidebarMenuItem>
                <MenuItemWrapper label="Reports">
                  <SidebarMenuButton asChild>
                    <Link
                      aria-label="Go to Reports"
                      href="/dashboard/reports"
                      className={`flex items-center ${pathname === "/dashboard/reports" ? "text-primary bg-gray-200 dark:bg-black/50" : ""}`}
                    >
